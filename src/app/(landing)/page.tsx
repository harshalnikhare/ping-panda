        ...
        <div className="relative mx-auto">
          <MaxWidthWrapper className="relative">
            <div
              ...
              ring-gray-900/10 lg:rounded-2xl lg:p-4"
            >
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage
            ...
            <div className="relative lg:row-span-2">
              ...
              >
                ...
                <div
                  ...
                  [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm"
                >
                  <div
              ...
              <div
                ...
                shadow ring-1 ring-black/5 lg:rounded-l-[2rem]"
              />
            </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div
                    className="absolute bottom-0 left-10 right-0 top-10
                    overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl"
                  >
                    <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                      <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                        <div
                          className="border-b border-r border-b-white/20
                          border-r-white/10 bg-white/20 px-4 py-2 text-white"
                        >
                          pingpanda.js
                        </div>
                      </div>
              ...
              <div
                className="pointer-events-none absolute inset-px rounded-lg
                shadow ring-1 ring-black/5 max-lg:rounded-b-[2rem]
                lg:rounded-r-[2rem]"
              />
            </div>
          </div>
      ...
      <section className="relative py-24 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            ...
            <Heading className="tex-center">What our customers say</Heading>
          </div>

          <div
            className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0
            lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x
            divide-gray-200"
          >
            {/* first customer review */}
            <div
              className="flex flex-auto flex-col gap-4 bg-brand-25 p-6
              sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none
              lg:rounded-l-[2rem]"
            >
              ...
              <p
                ...
                tracking-tight text-brand-950 text-center lg:text-left
                text-pretty"
              >
              ...
              sm:flex-row items-center sm:items-start gap-4 mt-2"
              >
                <Image
                  src="/user-2.png"
            ...
            <div
              className="flex flex-auto flex-col gap-4 bg-brand-25 p-6
              sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none
              lg:rounded-r-[2rem]"
            >
              <div className="flex gap-0.5 mb-2 justify-center lg:justify-start">
                <Star className="size-5 text-brand-600 fill-brand-600" />
          ...
          <ShinyButton
            href="/sign-up"
            className="relative z-10 h-14 w-full max-w-xs text-base shadow-lg
            transition-shadow duration-300 hover:shadow-xl"
          >
            Start For Free Today
          </ShinyButton>
